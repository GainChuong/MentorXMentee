...
import avatarHien from '../assets/avatar-female-1.png';
import avatarTam from '../assets/avatar-female-2.png';
import avatarAnh from '../assets/avatar-male-2.png';

const MOCK_NEWS = [
  { id: 1, tag: 'Sự kiện', title: 'Hội thảo Chuyển đổi số trong Giáo dục Đại học 2026', desc: 'Khoa HTTT phối hợp tổ chức hội thảo quốc tế về ứng dụng AI và công nghệ trong giáo dục...', date: '02/05/2026', featured: true, image: rect46 },
  { id: 2, tag: 'Tin tức', title: 'Sinh viên HTTT đạt giải nhất cuộc thi Hackathon toàn quốc', desc: 'Đội thi gồm 4 sinh viên năm 3 đã xuất sắc vượt qua 200 đội thi...', date: '28/04/2026', image: rect59 },
  { id: 3, tag: 'Tuyển dụng', title: 'FPT Software tuyển dụng thực tập sinh IT 2026', desc: 'Chương trình thực tập mùa hè dành cho sinh viên năm 3, năm 4...', date: '25/04/2026', image: rect64 },
  { id: 4, tag: 'Hoạt động', title: 'Chương trình Mentor x Mentee kết nối 50 cặp đôi mới', desc: 'Đợt kết nối tháng 4 đã ghép thành công 50 cặp mentor-mentee...', date: '20/04/2026', image: rect69 },
];
          ...
          <div className="news-col-left">
            ...
            <Link to="/news/1" className="main-featured-news-row">
              <div className="main-featured-img">
                <img src={rect46} alt="Vietnam Young Lions" />
              </div>
            ...
            <div className="sub-news-row">
              <Link to="/news/2" className="sub-news-card-col">
                <div className="sub-news-img"><img src={rect120} alt="Tân Phó Giáo sư" /></div>
              ...
              <Link to="/news/3" className="sub-news-card-col">
                <div className="sub-news-img"><img src={rect121} alt="Bằng Nhân Trí GLC 2025" /></div>
                <div className="sub-news-content">
                  <span className="tag-orange-text">Tin tức</span>
              ...
              <Link to="/news/4" className="sub-news-card-col">
                <div className="sub-news-img"><img src={rect50} alt="SAP Vietnam" /></div>
                <div className="sub-news-content">
                  <span className="tag-orange-text">Tin tức</span>
            ...
            <div className="news-col-right-scrollable">
              ...
              <Link to="/news/101" className="main-featured-event-card">
                <div className="main-event-img-wrapper">
                  <img src={rect59} alt="Ngày Về 2026" className="main-event-img" />
              ...
              <div className="sub-events-list">
                ...
                <Link to="/news/7" className="sub-event-item">
                  <div className="sub-event-img"><img src={rect128} alt="Văn nghệ" /></div>
                  <div className="sub-event-content">
          ...
          <div className="mentor-banner-figma">
            ...
            <div className="mentor-banner-figma-content">
              <div className="mentor-icon-figma">
                <img src={rect70} alt="Mentor icon" />
              </div>
