...
import './headerx-footer.css'

const HeaderxFooter = (props) => {
  return (
    <div className="headerx-footer-container1">
      <Helmet>
        <title>exported project</title>
        <meta property="og:title" content="exported project" />
        <link rel="canonical" href="https://untitled-ifirvm.teleporthq.app/" />
        <meta
          property="og:url"
          content="https://untitled-ifirvm.teleporthq.app/"
        />
      </Helmet>
      <div className="headerx-footer-thq-headerx-footer-elm">
        ...
        <div className="headerx-footer-thq-header-elm">
          ...
          />
          <span className="headerx-footer-thq-text-elm100">Trang Chủ</span>
          <span className="headerx-footer-thq-text-elm101">Giới Thiệu</span>
          <span className="headerx-footer-thq-text-elm102">
            Tin tức &amp; Sự Kiện
          </span>
          <span className="headerx-footer-thq-text-elm103">Diễn đàn</span>
          <span className="headerx-footer-thq-text-elm104">Quyên góp</span>
          <span className="headerx-footer-thq-text-elm105">
            Cơ hội việc làm
          </span>
          <img
          ...
          />
          <span className="headerx-footer-thq-text-elm106">
            <span className="headerx-footer-thq-text-elm107">EN</span>
            <span> | VI</span>
          </span>
          <img
          ...
          <div className="headerx-footer-thq-uel-alumni-elm">
            ...
            />
            <span className="headerx-footer-thq-text-elm109">
        ...
        />
        <div className="headerx-footer-thq-group57-elm">
          <span className="headerx-footer-thq-text-elm110">
            Nguyen Tran Van A
          </span>
          <img
          ...
          />
          <span className="headerx-footer-thq-text-elm111">MENTOR</span>
          <span className="headerx-footer-thq-text-elm112">Hồ sơ cá nhân</span>
          <span className="headerx-footer-thq-text-elm113">Đăng xuất</span>
        </div>
        <span className="headerx-footer-thq-text-elm114">Tìm kiếm Mentee</span>
        <span className="headerx-footer-thq-text-elm115">Đơn đăng ký</span>
        <span className="headerx-footer-thq-text-elm116">Quản lý Mentee</span>
        <span className="headerx-footer-thq-text-elm117">Tháng 5, 2026</span>
        <span className="headerx-footer-thq-text-elm118">
          <span className="headerx-footer-thq-text-elm119">CN</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm120">26</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm121">3</span>
          <br></br>
          <span>10</span>
          <br></br>
          <span>17</span>
        ...
        <span className="headerx-footer-thq-text-elm126">
          <span className="headerx-footer-thq-text-elm127">T2</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm128">27</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm129">4</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm130">11</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm131">18</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm132">25</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm133">1</span>
        </span>
        <span className="headerx-footer-thq-text-elm134">
          <span className="headerx-footer-thq-text-elm135">T3</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm136">28</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm137">5</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm138">12</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm139">19</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm140">26</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm141">2</span>
        </span>
        <span className="headerx-footer-thq-text-elm142">
          <span className="headerx-footer-thq-text-elm143">T4</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm144">29</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm145">6</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm146">13</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm147">20</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm148">27</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm149">3</span>
        </span>
        <span className="headerx-footer-thq-text-elm150">
          <span className="headerx-footer-thq-text-elm151">T5</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm152">30</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm153">7</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm154">14</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm155">21</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm156">28</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm157">4</span>
        </span>
        <span className="headerx-footer-thq-text-elm158">
          <span className="headerx-footer-thq-text-elm159">T6</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm160">1</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm161">8</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm162">15</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm163">22</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm164">29</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm165">5</span>
        </span>
        <span className="headerx-footer-thq-text-elm166">
          <span className="headerx-footer-thq-text-elm167">T7</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm168">2</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm169">9</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm170">16</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm171">23</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm172">30</span>
          <br></br>
        ...
        />
        <span className="headerx-footer-thq-text-elm174">Tạo lịch mới</span>
        ...
        />
        <span className="headerx-footer-thq-text-elm179">Huỳnh Gia Bảo</span>
        <span className="headerx-footer-thq-text-elm180">
          Data Analyst Track
        </span>
        <img
        ...
        />
        <span className="headerx-footer-thq-text-elm182">
          Hướng nghề mong muốn
          <span
        ...
        />
        <span className="headerx-footer-thq-text-elm184">
          Hướng nghề mong muốn
          <span
            dangerouslySetInnerHTML={{
              __html: ' ',
        ...
        />
        <span className="headerx-footer-thq-text-elm186">Họ và tên</span>
        ...
        />
        <span className="headerx-footer-thq-text-elm189">Họ và tên</span>
        ...
        />
        <span className="headerx-footer-thq-text-elm192">
          Xem tất cả yêu cầu
        </span>
        <img
        ...
        />
        <span className="headerx-footer-thq-text-elm198">
          <span className="headerx-footer-thq-text-elm199">CN</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm200"></span>
          <br></br>
          <span className="headerx-footer-thq-text-elm201">3</span>
        </span>
        <span className="headerx-footer-thq-text-elm202">
          <span className="headerx-footer-thq-text-elm203">T2</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm204"></span>
          <br></br>
          <span className="headerx-footer-thq-text-elm205">4</span>
        </span>
        <span className="headerx-footer-thq-text-elm206">
          <span className="headerx-footer-thq-text-elm207">T3</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm208"></span>
          <br></br>
          <span className="headerx-footer-thq-text-elm209">5</span>
        </span>
        <span className="headerx-footer-thq-text-elm210">
          <span className="headerx-footer-thq-text-elm211">T4</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm212"></span>
          <br></br>
          <span className="headerx-footer-thq-text-elm213">6</span>
        </span>
        <span className="headerx-footer-thq-text-elm214">
          <span className="headerx-footer-thq-text-elm215">T5</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm216"></span>
          <br></br>
          <span className="headerx-footer-thq-text-elm217">7</span>
        </span>
        <span className="headerx-footer-thq-text-elm218">
          <span className="headerx-footer-thq-text-elm219">T6</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm220"></span>
          <br></br>
          <span className="headerx-footer-thq-text-elm221">8</span>
        </span>
        <span className="headerx-footer-thq-text-elm222">
          <span className="headerx-footer-thq-text-elm223">T7</span>
          <br></br>
          <span className="headerx-footer-thq-text-elm224"></span>
          <br></br>
          <span className="headerx-footer-thq-text-elm225">9</span>
        </span>
        <span className="headerx-footer-thq-text-elm226">GMT +7</span>
        <span className="headerx-footer-thq-text-elm227">08:00</span>
        <span className="headerx-footer-thq-text-elm228">10:00</span>
        <span className="headerx-footer-thq-text-elm229">12:00</span>
        <span className="headerx-footer-thq-text-elm230">14:00</span>
        <span className="headerx-footer-thq-text-elm231">16:00</span>
        ...
        />
        <span className="headerx-footer-thq-text-elm234">
          meet.google.com/abc-defg-hij
        </span>
        <span className="headerx-footer-thq-text-elm235">22:00</span>
        ...
        />
        <span className="headerx-footer-thq-text-elm238">08:00 - 10:00</span>
        ...
        />
        <span className="headerx-footer-thq-text-elm241">14:00 - 16:00</span>
        ...
        />
        <span className="headerx-footer-thq-text-elm244">14:00 - 16:00</span>
        <span className="headerx-footer-thq-text-elm245">Họ và tên</span>
        <span className="headerx-footer-thq-text-elm246">Dạy gì đó</span>
        <span className="headerx-footer-thq-text-elm247">Huỳnh Gia Bảo</span>
        <span className="headerx-footer-thq-text-elm248">
          Chi tiết buổi học
        </span>
        <img
        ...
        />
        <span className="headerx-footer-thq-text-elm249">
          Review dự án cuối kỳ
        </span>
        <span className="headerx-footer-thq-text-elm250">
          Thứ Năm, dd/mm/yyyy
        </span>
        <span className="headerx-footer-thq-text-elm251">
          09:00 - 10:00 (1 tiếng)
        </span>
        <img
        ...
        />
        <span className="headerx-footer-thq-text-elm253">Nội dung</span>
        <span className="headerx-footer-thq-text-elm254">
          Review và góp ý dự án cuối kỳ của Mentee
        </span>
        <span className="headerx-footer-thq-text-elm255">
          <span>Chuẩn bị trước:</span>
          <br></br>
          <span>Hoàn thành báo cáo dự án</span>
          <br></br>
          <span>Chuẩn bị slide trình bày</span>
        </span>
        ...
        />
        <span className="headerx-footer-thq-text-elm260">
          Thêm ghi chú cho buổi họp này
        </span>
        ...
        />
        <span className="headerx-footer-thq-text-elm262">Huỳnh Gia Bảo</span>
        <span className="headerx-footer-thq-text-elm263">
          Data Analyst Track
        </span>
        <img
        ...
        />
        <span className="headerx-footer-thq-text-elm266">
          Gửi lịch cho Mentee
        </span>
        <img
        ...
        />
        <div className="headerx-footer-thq-footer-elm1">
          <div className="headerx-footer-thq-bnquyn-elm">
            <span className="headerx-footer-thq-text-elm269">
              Bản quyền © 2026 - Khoa Hệ Thống thông tin, Trường Đại học Kinh tế
              Luật, ĐHQG - HCM
            </span>
          </div>
          <img
          ...
          />
          <span className="headerx-footer-thq-text-elm270">
            THÔNG TIN LIÊN HỆ
          </span>
          <img
          ...
          />
          <span className="headerx-footer-thq-text-elm271">
            <span className="headerx-footer-thq-text-elm272">
              Số 669 Đỗ Mười, Khu phố 13, Phường Linh Xuân, TP. HCM
            </span>
            <br></br>
            <span className="headerx-footer-thq-text-elm273">
              Điện thoại: 028 3724 4555
            </span>
            <br></br>
            <span className="headerx-footer-thq-text-elm274">
              Email:
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
          ...
          />
          <span className="headerx-footer-thq-text-elm276">Theo dõi ngay</span>
          <span className="headerx-footer-thq-text-elm277">
          ...
          />
          <span className="headerx-footer-thq-text-elm278">
            <span>
              Đăng ký ngay để cập nhật tin tức, sự kiện và thông tin tuyển
              <span
                dangerouslySetInnerHTML={{
                  __html: ' ',
                }}
          ...
          />
          <span className="headerx-footer-thq-text-elm284">
        ...
        <span className="headerx-footer-thq-text-elm290">← Quay lại</span>
      </div>
      <a
        href="https://play.teleporthq.io/signup"
        className="headerx-footer-link"
      >
        <div
          aria-label="Sign up to TeleportHQ"
          className="headerx-footer-container2"
        >
          <svg
            width="24"
            height="24"
            ...
            className="headerx-footer-icon1"
          >
            <path
          ...
          <span className="headerx-footer-text75">Built in TeleportHQ</span>
        </div>
      </a>
    </div>
  )
